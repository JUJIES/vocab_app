...
- **Neue Sets sind serverseitige Entwürfe:** Sobald eine Lehrkraft bei einem neuen Set sinnvolle Inhalte eingibt oder einen Import übernimmt, wird der Stand verzögert automatisch im bestehenden Set-Speicher gesichert. Entwürfe dürfen unvollständige Karten enthalten, besitzen keinen Share-Code und sind für Tablets nicht auflösbar. Die Set-Liste kennzeichnet sie dezent; erst `Set veröffentlichen` wendet die vollständige Set-Validierung an und erzeugt den stabilen Share-Code. Ein Klick auf den Modalhintergrund schließt den Editor nicht.
