...
const FORMAL_VISUAL_DIRECTION = "Use the same calm, modern, friendly editorial illustration language, the same edge-to-edge dark navy background, comparable subject scale, comfortable padding, restrained detail, and strong classroom legibility.";
...
function buildSheetPrompt(cards) {
  ...
  return [
    ...
    `${FORMAL_VISUAL_DIRECTION} Apply this formal direction consistently in every cell. The representation may still differ independently by meaning: concrete object, action, human interaction, relation, diagram, symbolic composition, or full scene.`,
...
function buildSinglePrompt(card) {
  ...
  return [
    ...
    `${FORMAL_VISUAL_DIRECTION} This formal direction is mandatory even though the semantic representation is chosen independently for this card.`,
