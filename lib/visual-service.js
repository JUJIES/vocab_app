...
function buildSheetPrompt(cards) {
  ...
  return [
    ...
    "Use the same calm, modern, friendly editorial illustration language, the same edge-to-edge dark navy background, comparable subject scale, comfortable padding, restrained detail, and strong classroom legibility in every cell. The representation may still differ independently by meaning: concrete object, action, human interaction, relation, diagram, symbolic composition, or full scene.",
    "Keep every foreground subject, symbol, diagram mark, and other meaningful object inside the central area of its own cell, leaving an approximately 48-pixel quiet zone of background at all four cell edges. Full-scene background scenery may continue through this quiet zone, but no distinct object or foreground detail may enter or cross it.",
...
function buildSinglePrompt(card) {
  ...
  return [
    ...
    "Use comfortable padding, simple shapes, a clear silhouette, restrained detail, and a dark navy background where background is needed.",
